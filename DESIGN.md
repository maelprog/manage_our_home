...
renvoi. #72 s'en est servi une fois, sur l'entrée du 2026-08-06 qui relève le
plafond de feuille (`fb59324`).
...
| 2026-08-29 | La convention de ce journal énonce son exception : un récit **faux** se corrige en place (#72) | La convention posée en tête — « une entrée datée n'est jamais réécrite, ce qu'on peut lui ajouter est un renvoi » — était démentie par le lot qui l'a écrite : `fb59324` a réécrit **en place** le motif de l'entrée du 2026-08-06 sur le plafond de feuille. L'acte est validé et n'est pas défait : l'entrée réécrite avait été écrite par ce lot quatre jours plus tôt, elle n'avait jamais quitté la branche, et la PR atterrira de toute façon en un seul commit — empiler un renvoi sur un motif que personne n'avait lu ailleurs aurait coûté au lecteur sans rien préserver. Ce qui manquait, c'est que la règle n'énonçait aucune exception et que l'entrée réécrite ne portait aucune marque : un futur auteur aurait lu la règle comme absolue, un futur vérificateur l'aurait comparée à l'historique et aurait conclu à une infraction commise par le lot qui l'écrit. L'exception est donc écrite et **bornée** — elle ne vaut que pour une entrée du lot en cours, la décision, sa date et ses valeurs sont immuables, seul le motif est réécrit, la marque est obligatoire, et une entrée datée dit ce qui a été corrigé. Une entrée atterrie n'en bénéficie pas. La marque manquante est posée |
