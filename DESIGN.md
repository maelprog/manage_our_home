...
l'auteur de l'entrée. Ainsi bornée, elle est aussi vérifiable par une machine,
qui compare le journal à celui de `main` et non à un historique de branche que
le squash fait disparaître (#95).
