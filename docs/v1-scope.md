...
**Current status (2026-07-24):** F1–F8 are **done** and merged, in
...
and a Playwright E2E merge-gate suite. F7 wired the price-on-checkout hook F6
deferred (inline price form on a checked grocery item →
...
backend epic #7 had deferred. **Next: F9/F10** — they depend only on F1/F2 and
