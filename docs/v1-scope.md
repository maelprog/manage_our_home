...
**Immediate next step:** epic #4 (Recipes) has landed; start epic #5 (Grocery list) inside `apps/api/`, which depends on both Stocks and Recipes' structured ingredient lists.
