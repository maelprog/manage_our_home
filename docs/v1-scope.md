...
**Current status (2026-07-27):** **every front epic F1–F10 is done** — the front
...
**Remaining for v1:** the Google Calendar import UI (row below, not yet filed —
the last unfiled front surface), #11 (transactional email finish-up) and #14
(flesh out docker-compose/Caddy). #13 (CI) already covers the whole Rust
workspace.
